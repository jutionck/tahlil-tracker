...
const coreYasinVerseDetails: Verse[] = [
  { id: 1, arabic: "يٰسۤ", latin: "Yaa-Seeen", translation: "Ya Sin." },
...
export const coreYasinVerses: Verse[] = coreYasinVerseDetails.map((verse, index) => ({
  ...verse,
  arabic: yasinArabicText[index] ?? verse.arabic,
  latin: index >= 18 ? yasinLatinTextFrom19[index - 18] ?? verse.latin : verse.latin,
}));
